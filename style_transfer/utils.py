...
def get_masked_with_pad_tensor(size, src, trg, pad_token=0):
    ...
    :param src: source tensor -- (b, t)
    :param trg: target tensor -- (b, t)
...
if __name__ == '__main__':
    ...
    src_mask, trg_mask, look_ahead_mask = get_masked_with_pad_tensor(100, s, t)
    print("src_mask", src_mask, src_mask.shape)
    print("trg_mask", trg_mask, trg_mask.shape)
    print("look_ahead_mask", look_ahead_mask, look_ahead_mask.shape)
